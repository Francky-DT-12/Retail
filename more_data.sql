...
-- Données supplémentaires pour la table `products`
INSERT INTO `products` (`id`, `pName`, `price`, `description`, `available`, `category`, `item`, `pCode`, `picture`, `date`) VALUES
(5, 'Polo Lacoste', 2500, 'Polo de marque Lacoste en coton, disponible en plusieurs couleurs', 15, 'tshirt', 'polo', 'p-001', 'polo_lacoste.jpg', '2024-01-10 09:20:00'),
(6, 'Sneakers Nike Air Max', 8500, 'Chaussures de sport Nike Air Max, confortables et stylées', 12, 'shoes', 'sneakers', 'sn-001', 'nike_airmax.jpg', '2024-01-11 14:30:00'),
(7, 'Portefeuille Louis Vuitton', 15000, 'Portefeuille en cuir véritable Louis Vuitton avec compartiments multiples', 5, 'wallet', 'luxury-wallet', 'lv-001', 'lv_wallet.jpg', '2024-01-12 10:15:00'),
(8, 'Ceinture Hermès', 12000, 'Ceinture en cuir Hermès avec boucle signature', 8, 'belt', 'luxury-belt', 'h-001', 'hermes_belt.jpg', '2024-01-13 16:45:00'),
(9, 'T-Shirt Adidas', 450, 'T-shirt de sport Adidas en matière respirante', 25, 'tshirt', 'sport-tshirt', 'ad-001', 'adidas_tshirt.jpg', '2024-01-14 11:20:00'),
(10, 'Chaussures de ville', 4500, 'Chaussures élégantes en cuir noir pour occasions formelles', 10, 'shoes', 'formal-shoes', 'fs-001', 'formal_shoes.jpg', '2024-01-15 13:30:00'),
(11, 'Sweat à capuche Nike', 3200, 'Sweat-shirt à capuche Nike, parfait pour le sport et les loisirs', 18, 'tshirt', 'hoodie', 'nk-002', 'nike_hoodie.jpg', '2024-01-16 09:45:00'),
(12, 'Baskets Converse', 2800, 'Baskets iconiques Converse All Star en toile', 22, 'shoes', 'sneakers', 'cv-001', 'converse_allstar.jpg', '2024-01-17 15:20:00'),
(13, 'Portefeuille cuir simple', 850, 'Portefeuille en cuir synthétique avec porte-cartes', 30, 'wallet', 'basic-wallet', 'bw-001', 'basic_wallet.jpg', '2024-01-18 08:30:00'),
(14, 'Ceinture tressée', 650, 'Ceinture tressée en tissu, ajustable et décontractée', 20, 'belt', 'casual-belt', 'cb-001', 'braided_belt.jpg', '2024-01-19 12:15:00'),
(15, 'Chemise business', 1800, 'Chemise blanche classique pour le bureau', 16, 'tshirt', 'shirt', 'bs-001', 'business_shirt.jpg', '2024-01-20 14:40:00'),
(16, 'Bottines Chelsea', 5500, 'Bottines Chelsea en cuir marron, style britannique', 7, 'shoes', 'boots', 'cb-002', 'chelsea_boots.jpg', '2024-01-21 10:25:00'),
(17, 'Portefeuille RFID', 1200, 'Portefeuille avec protection RFID contre le piratage', 14, 'wallet', 'tech-wallet', 'rf-001', 'rfid_wallet.jpg', '2024-01-22 16:30:00'),
(18, 'Ceinture réversible', 2200, 'Ceinture réversible noir/marron en cuir véritable', 11, 'belt', 'reversible-belt', 'rb-001', 'reversible_belt.jpg', '2024-01-23 09:10:00'),
(19, 'T-Shirt vintage', 750, 'T-shirt au design vintage avec impression rétro', 28, 'tshirt', 'vintage-tee', 'vt-001', 'vintage_tshirt.jpg', '2024-01-24 13:50:00'),
(20, 'Mocassins italiens', 6800, 'Mocassins en cuir italien fait main', 6, 'shoes', 'loafers', 'mi-001', 'italian_loafers.jpg', '2024-01-25 11:40:00');

-- Données supplémentaires pour la table `product_level`
...
-- Ajout d'articles électroniques et autres catégories
INSERT INTO `products` (`id`, `pName`, `price`, `description`, `available`, `category`, `item`, `pCode`, `picture`, `date`) VALUES
-- Smartphones
(21, 'iPhone 15 Pro', 119900, 'Smartphone Apple iPhone 15 Pro 128GB, écran Super Retina XDR 6.1", puce A17 Pro, système de caméra Pro avancé', 8, 'electronics', 'smartphone', 'iph-001', 'iphone15pro.jpg', '2025-06-20 10:30:00'),
(22, 'Samsung Galaxy S24', 89900, 'Samsung Galaxy S24 256GB, écran Dynamic AMOLED 6.2", processeur Exynos 2400, triple caméra 50MP', 12, 'electronics', 'smartphone', 'sam-001', 'galaxy_s24.jpg', '2025-06-21 14:15:00'),
(23, 'Google Pixel 8', 69900, 'Google Pixel 8 128GB, écran OLED 6.2", puce Tensor G3, caméra principale 50MP avec IA', 15, 'electronics', 'smartphone', 'goo-001', 'pixel8.jpg', '2025-06-22 09:45:00'),

-- Ordinateurs portables
(24, 'MacBook Air M3', 129900, 'Apple MacBook Air 13" avec puce M3, 8GB RAM, 256GB SSD, écran Liquid Retina', 6, 'electronics', 'laptop', 'mac-001', 'macbook_air_m3.jpg', '2025-06-23 11:20:00'),
(25, 'Dell XPS 13', 119900, 'Dell XPS 13 Intel Core i7-1355U, 16GB RAM, 512GB SSD, écran InfinityEdge 13.4"', 4, 'electronics', 'laptop', 'del-001', 'dell_xps13.jpg', '2025-06-24 16:30:00'),
(26, 'HP Pavilion Gaming', 79900, 'HP Pavilion Gaming 15.6" AMD Ryzen 5, 16GB RAM, 512GB SSD, NVIDIA GTX 1650', 10, 'electronics', 'laptop', 'hp-001', 'hp_pavilion.jpg', '2025-06-25 13:25:00'),

-- Écouteurs et audio
(27, 'AirPods Pro 2', 27900, 'Apple AirPods Pro 2ème génération avec réduction de bruit active et étui de charge MagSafe', 20, 'electronics', 'headphones', 'air-001', 'airpods_pro2.jpg', '2025-06-26 08:40:00'),
(28, 'Sony WH-1000XM5', 34900, 'Casque sans fil Sony WH-1000XM5 avec réduction de bruit de pointe, autonomie 30h', 18, 'electronics', 'headphones', 'son-001', 'sony_wh1000xm5.jpg', '2025-06-26 12:15:00'),
(29, 'Bose QuietComfort', 32900, 'Casque Bose QuietComfort avec réduction de bruit, confort exceptionnel, autonomie 24h', 14, 'electronics', 'headphones', 'bos-001', 'bose_qc.jpg', '2025-06-27 09:30:00'),

-- Montres connectées
(30, 'Apple Watch Series 9', 45900, 'Apple Watch Series 9 GPS 45mm, boîtier aluminium, bracelet sport, écran Always-On Retina', 25, 'electronics', 'smartwatch', 'apw-001', 'apple_watch_s9.jpg', '2025-06-27 14:20:00'),
(31, 'Samsung Galaxy Watch 6', 32900, 'Samsung Galaxy Watch 6 44mm, écran Super AMOLED, suivi santé avancé, étanche 50m', 16, 'electronics', 'smartwatch', 'sgw-001', 'galaxy_watch6.jpg', '2025-06-27 15:10:00'),

-- Appareils photo
(32, 'Canon EOS R6 Mark II', 279900, 'Appareil photo hybride Canon EOS R6 Mark II, capteur 24.2MP, vidéo 4K, stabilisation 8 stops', 3, 'electronics', 'camera', 'can-001', 'canon_r6m2.jpg', '2025-06-20 16:45:00'),
(33, 'Sony Alpha A7 IV', 249900, 'Sony Alpha A7 IV hybride plein format, 33MP, vidéo 4K 60p, stabilisation 5 axes', 5, 'electronics', 'camera', 'soa-001', 'sony_a7iv.jpg', '2025-06-21 10:30:00'),

-- Tablettes
(34, 'iPad Air M2', 69900, 'Apple iPad Air 11" avec puce M2, 128GB, écran Liquid Retina, compatible Apple Pencil', 22, 'electronics', 'tablet', 'ipa-001', 'ipad_air_m2.jpg', '2025-06-22 13:50:00'),
(35, 'Samsung Galaxy Tab S9', 59900, 'Samsung Galaxy Tab S9 11" 128GB, écran Dynamic AMOLED 2X, S Pen inclus', 19, 'electronics', 'tablet', 'sgt-001', 'galaxy_tab_s9.jpg', '2025-06-23 11:15:00'),

-- Accessoires auto
(36, 'Dashcam 4K', 15900, 'Caméra embarquée 4K avec vision nocturne, GPS intégré, enregistrement en boucle', 30, 'automotive', 'dashcam', 'dc-001', 'dashcam_4k.jpg', '2025-06-24 09:20:00'),
(37, 'Chargeur voiture sans fil', 4900, 'Support de téléphone avec chargeur sans fil Qi 15W, fixation ventilation', 45, 'automotive', 'charger', 'cc-001', 'car_wireless_charger.jpg', '2025-06-25 14:35:00'),

-- Maison connectée
(38, 'Amazon Echo Dot 5', 5900, 'Enceinte connectée Amazon Echo Dot 5ème génération avec Alexa, son amélioré', 35, 'smart-home', 'speaker', 'ama-001', 'echo_dot5.jpg', '2025-06-26 10:25:00'),
(39, 'Philips Hue Starter Kit', 19900, 'Kit de démarrage Philips Hue avec 3 ampoules LED connectées E27 et pont', 28, 'smart-home', 'lighting', 'phi-001', 'philips_hue_kit.jpg', '2025-06-27 12:40:00'),
(40, 'Ring Video Doorbell', 9900, 'Sonnette vidéo Ring avec détection de mouvement, vision nocturne HD, audio bidirectionnel', 24, 'smart-home', 'security', 'rin-001', 'ring_doorbell.jpg', '2025-06-27 15:15:00'),

-- Consoles et jeux
(41, 'PlayStation 5', 59999, 'Console Sony PlayStation 5 avec lecteur Ultra HD Blu-ray, SSD 825GB, manette DualSense', 8, 'gaming', 'console', 'ps5-001', 'playstation5.jpg', '2025-06-20 14:30:00'),
(42, 'Nintendo Switch OLED', 34999, 'Console Nintendo Switch modèle OLED avec écran 7", dock et Joy-Con', 15, 'gaming', 'console', 'nin-001', 'switch_oled.jpg', '2025-06-21 16:20:00'),
(43, 'Xbox Series X', 54999, 'Console Microsoft Xbox Series X 1TB, 4K native, 120fps, rétrocompatibilité', 12, 'gaming', 'console', 'xbo-001', 'xbox_series_x.jpg', '2025-06-22 11:45:00');
...
-- Nouvelles commandes pour les appareils électroniques
INSERT INTO `orders` (`id`, `uid`, `ofname`, `pid`, `quantity`, `oplace`, `mobile`, `dstatus`, `odate`, `ddate`) VALUES
...
-- Nouvelles vues de produits pour les appareils
INSERT INTO `product_view` (`id`, `user_id`, `product_id`, `date`) VALUES
...
-- Utilisateurs supplémentaires (clients récents)
INSERT INTO `users` (`id`, `name`, `email`, `username`, `password`, `mobile`, `reg_time`, `online`, `activation`) VALUES
